...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FlagInstance.flag_type'
        db.add_column(u'flaggit_flaginstance', 'flag_type',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FlagInstance.flag_type'
        db.delete_column(u'flaggit_flaginstance', 'flag_type')
    ...
    models = {
        ...
        u'flaggit.flaginstance': {
            ...
            'flag_type': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
