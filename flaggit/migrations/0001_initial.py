...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Flag'
        db.create_table(u'flaggit_flag', (
        ...
        db.send_create_signal(u'flaggit', ['Flag'])

        # Adding model 'FlagInstance'
        db.create_table(u'flaggit_flaginstance', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('flag', self.gf('django.db.models.fields.related.ForeignKey')(related_name='flags', to=orm['flaggit.Flag'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True, blank=True)),
            ('datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'flaggit', ['FlagInstance'])


    def backwards(self, orm):
        # Deleting model 'Flag'
        db.delete_table(u'flaggit_flag')

        # Deleting model 'FlagInstance'
        db.delete_table(u'flaggit_flaginstance')
    ...
    models = {
        ...
        u'flaggit.flaginstance': {
            'Meta': {'object_name': 'FlagInstance'},
            'comment': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'datetime': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'flag': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'flags'", 'to': u"orm['flaggit.Flag']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
